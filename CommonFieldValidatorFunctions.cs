...
namespace FieldValidatorAPI
{
    ...
    public class CommonFieldValidatorFunctions
    {
        ...
        public static CompareFieldsValidDel FieldsComparisonValidDel
        {
            get
            {
                if(_compareFieldsValidDel == null)
                {
                    _compareFieldsValidDel = new CompareFieldsValidDel(FieldsComparisonValid);
                }
        ...
        private static bool FieldsComparisonValid(string fieldVal, string fieldValCompare)
        {
